...
export default function Questions(props){
    ...
    const getQuestions = async () => {
        try{
            const response = await fetch('https://cors-anywhere.herokuapp.com/https://devcon4-back.herokuapp.com/api/questions'); 
    ...
    const handleQuestionSubmit = async (event) => {
        ...
        if (questionFormInputs.category === ''){
            ...
            try{
                ...
                const response = await axios.post('https://cors-anywhere.herokuapp.com/https://devcon4-back.herokuapp.com/api/questions', questionFormInputs);
    ...
    const handleQuestionDelete = async (event) => {
        ...
        console.log(`look here ${event.target.id}`);
            await axios.delete(`https://cors-anywhere.herokuapp.com/https://devcon4-back.herokuapp.com/api/questions/${event.target.id}`)
        } catch(error){
            console.error(error)
        };
        };
    ...
    const handleClickUpdateQuestion = async (event) => {
        event.preventDefault();
        const response = await axios.get(`https://cors-anywhere.herokuapp.com/https://devcon4-back.herokuapp.com/api/questions/${event.target.id}`);
    ...
    const handleQuestionUpdateSubmit = async (event) => {
        event.preventDefault();
        const response = await axios.put(`https://cors-anywhere.herokuapp.com/https://devcon4-back.herokuapp.com/api/questions/${event.target.id}`, {topic: questionUpdate.topic, body: questionUpdate.body});
