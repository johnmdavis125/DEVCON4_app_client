    ...
    <div>  
        <div class='columns'>
            <div class='column' style={{paddingTop: '0', paddingBottom: '0'}}>
                ...
                <h3 style={{display: 'flex', justifyContent: 'space-around'}}><span>Q&A Support</span><span>|</span><span>Training</span><span>|</span><span>Community</span></h3>
        ...
        <div class="columns" style={{backgroundColor: 'rgb(12, 56, 106)'}}>
            ...
            <div class="column is-two-thirds">
                <h4 style={{color: 'rgba(255, 255, 255, 0.9)'}}>Reference/Training Materials</h4>
